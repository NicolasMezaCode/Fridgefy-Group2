...
export const getRecipeSummary = async (id) =>{
    try{
        const res = await axios.get(`${process.env.REACT_APP_SPOONACULAR_SUMMARY_URL}?apiKey=${process.env.REACT_APP_SPOONACULAR_API_KEY}/${id}/information?includeNutrition=false`);
        // console.log(res);
